-- Assessment Manager Database Schema - Clerk Compatible
-- Updated to use TEXT for user_id fields to support Clerk user IDs

-- Enable UUID extension for other IDs
...
-- Profiles policies - updated for Clerk compatibility
...
-- Assessments policies - updated for Clerk compatibility
...
-- Tasks policies - updated for Clerk compatibility
...
-- Progress metrics policies - updated for Clerk compatibility
...
-- Planner sessions policies - updated for Clerk compatibility
...
-- Subjects policies - updated for Clerk compatibility
...
-- Study sessions policies - updated for Clerk compatibility
